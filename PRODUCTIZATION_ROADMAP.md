...
- The seller-side local media-library foundation now exists, and the remaining owner-facing AI image generation is now focused on per-item dish/drink images instead of the older hero/gallery media studio path
...
- The live AI media flow is now intentionally narrower: keep owner-facing AI generation focused on per-item dish/drink images while the older hero/gallery studio path is being removed from the shipped flow
