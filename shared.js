...
Object.assign(window.translations.fr, {
    ...
    'admin.lang.french': 'Français',
    'admin.lang.english': 'Anglais',
    'admin.lang.arabic': 'Arabe',
    ...
    'admin.menu.gallery': 'Téléversements de galerie',
    ...
    'admin.table.featured': 'Mise en avant',
    'admin.table.actions': 'Actions',
    'admin.table.action': 'Action',
    'admin.table.items': 'Articles',
    'admin.table.visual': 'Visuel',
    'admin.table.emoji': 'Emoji',
    'admin.table.includes': 'Inclus',
    'admin.supercategories.title': 'Super catégories (périodes de service)',
    'admin.supercategories.subtitle': 'Regroupez vos catégories (ex. Petit-déjeuner, Déjeuner, Dîner).',
    'admin.import.title': 'Import menu',
    'admin.import.subtitle': 'Transformez des images/PDF de menu en brouillon relecture avant publication.',
    ...
    'admin.wifi.password': 'Mot de passe',
...
Object.assign(window.translations.fr, {
    'admin.branding.title': 'Configuration de marque',
    'admin.branding.subtitle': 'Configurez l’identité, les couleurs et les médias du restaurant.',
    ...
    'admin.branding.tab_identity': 'Identité',
    'admin.branding.tab_homepage': 'Homepage',
    'admin.branding.tab_gallery': 'Galerie',
    'admin.branding.kicker_identity': 'Branding',
    'admin.branding.kicker_homepage': 'Homepage',
    'admin.branding.kicker_gallery': 'Galerie',
    'admin.branding.identity_setup': 'Configuration de marque',
    'admin.branding.identity_palette': 'Identité et palette principale',
    'admin.branding.core_palette': 'Palette principale',
    'admin.branding.advanced_colors': 'Couleurs avancées',
    'admin.branding.logo_hero_media': 'Logo et médias hero',
    'admin.branding.homepage_setup': 'Configuration homepage',
    'admin.branding.homepage_layout': 'Structure homepage',
    'admin.branding.homepage_copy': 'Textes homepage',
    'admin.branding.save_homepage': 'Enregistrer la homepage',
    'admin.branding.gallery_setup': 'Configuration galerie',
    'admin.branding.gallery_assets': 'Médias de galerie',
    'admin.branding.preset_core': 'Core / marque blanche',
    'admin.branding.preset_fast_food': 'Fast food / street food',
    'admin.branding.preset_cafe': 'Café / brunch',
    'admin.branding.preset_traditional': 'Traditionnel / restaurant familial',
    'admin.branding.preview_kicker': 'Aperçu de marque',
    'admin.branding.preview_title_template': 'Site {name}',
    'admin.branding.preview_hero_text': 'Le logo, les couleurs et l’image hero se mettront à jour ici.',
    'admin.branding.preview_identity_text': 'Aperçu de l’identité de marque',
    'admin.branding.preview_homepage_text': 'Aperçu du hero, du CTA et des médias homepage.',
    'admin.branding.preview_preset_template': 'Aperçu {preset}',
    'admin.branding.preview_menu': 'Menu',
    'admin.branding.preview_selection_template': 'Sélection {name}',
    'admin.branding.preview_menu_card_text': 'Cartes menu, profondeur du fond et contraste accent pour le preset {preset}.',
    'admin.branding.swatch_primary': 'Principal',
    'admin.branding.swatch_secondary': 'Secondaire',
    'admin.branding.swatch_accent': 'Accent',
    'admin.branding.preview_homepage_hero': 'Hero homepage',
    'admin.branding.preview_homepage': 'Homepage',
    'admin.branding.preview_order_online': 'Commander',
    'admin.branding.preview_menu_shell': 'Menu',
    'admin.branding.preview_categories_card': 'Catégories + carte',
    'admin.branding.preview_desserts': 'Desserts',
    'admin.branding.preview_beverages': 'Boissons',
    'admin.branding.preview_signature_pick': 'Choix signature',
    'admin.branding.preview_signature': 'Signature',
    'admin.branding.preview_static_title': 'Site du restaurant',
    'admin.branding.preview_static_name': 'Nom du restaurant',
    'admin.branding.preview_static_tagline': 'Aperçu de la signature et de l’identité',
    'admin.branding.preview_static_homepage_title': 'Site du restaurant',
    'admin.branding.preview_static_homepage_meta': 'Service chaleureux et identité locale',
    'admin.branding.preview_static_chip_primary': 'Signatures',
    'admin.branding.preview_static_card_title': 'Plat signature de saison',
    'admin.branding.preview_static_card_text': 'Surface, ambiance de carte et contraste accent pour l’expérience menu.',
...
Object.assign(window.translations.en, {
    ...
    'admin.menu.gallery': 'Gallery uploads',
    ...
    'admin.table.visual': 'Visual',
    'admin.table.emoji': 'Emoji',
    'admin.table.includes': 'Includes',
    'admin.supercategories.title': 'Super categories (meal periods)',
    'admin.supercategories.subtitle': 'Group your categories (e.g. Breakfast, Lunch, Dinner).',
    'admin.import.title': 'Menu import',
    'admin.import.subtitle': 'Turn menu images or a PDF into a reviewable draft before publishing.',
    ...
    'admin.branding.tab_identity': 'Identity',
    'admin.branding.tab_homepage': 'Homepage',
    'admin.branding.tab_gallery': 'Gallery',
    'admin.branding.kicker_identity': 'Branding',
    'admin.branding.kicker_homepage': 'Homepage',
    'admin.branding.kicker_gallery': 'Gallery',
    'admin.branding.identity_setup': 'Brand setup',
    'admin.branding.identity_palette': 'Identity & core palette',
    'admin.branding.core_palette': 'Core palette',
    'admin.branding.advanced_colors': 'Advanced theme colors',
    'admin.branding.logo_hero_media': 'Logo & hero media',
    'admin.branding.homepage_setup': 'Homepage setup',
    'admin.branding.homepage_layout': 'Homepage layout',
    'admin.branding.homepage_copy': 'Homepage copy',
    'admin.branding.save_homepage': 'Save Homepage Settings',
    'admin.branding.gallery_setup': 'Gallery setup',
    'admin.branding.gallery_assets': 'Gallery assets',
    'admin.branding.preset_core': 'Core / White Label',
    'admin.branding.preset_fast_food': 'Fast Food / Street Food',
    'admin.branding.preset_cafe': 'Cafe / Brunch',
    'admin.branding.preset_traditional': 'Traditional / Family Restaurant',
    'admin.branding.preview_kicker': 'Brand Preview',
    'admin.branding.preview_title_template': '{name} website',
    'admin.branding.preview_hero_text': 'Logo, colors, and cover image will update here as you edit.',
    'admin.branding.preview_identity_text': 'Brand identity preview',
    'admin.branding.preview_homepage_text': 'Homepage hero, CTA, and media preview.',
    'admin.branding.preview_preset_template': '{preset} preview',
    'admin.branding.preview_menu': 'Menu',
    'admin.branding.preview_selection_template': '{name} Selection',
    'admin.branding.preview_menu_card_text': 'Menu cards, background depth, and accent contrast for the {preset} preset.',
    'admin.branding.swatch_primary': 'Primary',
    'admin.branding.swatch_secondary': 'Secondary',
    'admin.branding.swatch_accent': 'Accent',
    'admin.branding.preview_homepage_hero': 'Homepage hero',
    'admin.branding.preview_homepage': 'Homepage',
    'admin.branding.preview_order_online': 'Order Online',
    'admin.branding.preview_menu_shell': 'Menu shell',
    'admin.branding.preview_categories_card': 'Categories + card',
    'admin.branding.preview_desserts': 'Desserts',
    'admin.branding.preview_beverages': 'Beverages',
    'admin.branding.preview_signature_pick': 'Signature pick',
    'admin.branding.preview_signature': 'Signature',
    'admin.branding.preview_static_title': 'Restaurant website',
    'admin.branding.preview_static_name': 'Restaurant Name',
    'admin.branding.preview_static_tagline': 'Tagline and identity summary preview',
    'admin.branding.preview_static_homepage_title': 'Restaurant website',
    'admin.branding.preview_static_homepage_meta': 'Warm service and local identity',
    'admin.branding.preview_static_chip_primary': 'Signatures',
    'admin.branding.preview_static_card_title': 'Seasonal Signature Plate',
    'admin.branding.preview_static_card_text': 'Surface, card mood, and accent color preview for the menu experience.',
...
Object.assign(window.translations.ar, {
    ...
    'admin.lang.french': 'الفرنسية',
    'admin.lang.english': 'الإنجليزية',
    'admin.lang.arabic': 'العربية',
    ...
    'admin.menu.gallery': 'تحميلات المعرض',
    ...
    'admin.table.likes': 'إعجابات',
    'admin.table.featured': 'مميز',
    'admin.table.actions': 'الإجراءات',
    'admin.table.action': 'إجراء',
    'admin.table.items': 'العناصر',
    'admin.table.visual': 'صورة',
    'admin.table.emoji': 'إيموجي',
    'admin.table.includes': 'يتضمن',
    'admin.supercategories.title': 'الفئات العليا (فترات الوجبات)',
    'admin.supercategories.subtitle': 'نظم الفئات حسب الوقت (مثل الإفطار، الغداء، العشاء).',
    'admin.import.title': 'استيراد القائمة',
    'admin.import.subtitle': 'حوّل صور/ملفات PDF للقائمة إلى مسودة قابلة للمراجعة قبل النشر.',
    ...
    'admin.wifi.password': 'كلمة المرور',
    ...
    'admin.branding.tab_identity': 'الهوية',
    'admin.branding.tab_homepage': 'الرئيسية',
    'admin.branding.tab_gallery': 'المعرض',
    'admin.branding.kicker_identity': 'الهوية',
    'admin.branding.kicker_homepage': 'الرئيسية',
    'admin.branding.kicker_gallery': 'المعرض',
    'admin.branding.identity_setup': 'إعداد الهوية',
    'admin.branding.identity_palette': 'الهوية والألوان الرئيسية',
    'admin.branding.core_palette': 'الألوان الرئيسية',
    'admin.branding.advanced_colors': 'ألوان متقدمة',
    'admin.branding.logo_hero_media': 'الشعار وصور الواجهة',
    'admin.branding.homepage_setup': 'إعداد الصفحة الرئيسية',
    'admin.branding.homepage_layout': 'ترتيب الصفحة الرئيسية',
    'admin.branding.homepage_copy': 'نصوص الصفحة الرئيسية',
    'admin.branding.save_homepage': 'حفظ إعدادات الصفحة الرئيسية',
    'admin.branding.gallery_setup': 'إعداد المعرض',
    'admin.branding.gallery_assets': 'صور المعرض',
    'admin.branding.preset_core': 'أساسي / علامة بيضاء',
    'admin.branding.preset_fast_food': 'وجبات سريعة / شارع',
    'admin.branding.preset_cafe': 'مقهى / برنش',
    'admin.branding.preset_traditional': 'تقليدي / مطعم عائلي',
    'admin.branding.preview_kicker': 'معاينة الهوية',
    'admin.branding.preview_title_template': 'موقع {name}',
    'admin.branding.preview_hero_text': 'سيتم تحديث الشعار والألوان وصورة الواجهة هنا أثناء التعديل.',
    'admin.branding.preview_identity_text': 'معاينة هوية العلامة',
    'admin.branding.preview_homepage_text': 'معاينة الواجهة وزر الطلب ووسائط الصفحة الرئيسية.',
    'admin.branding.preview_preset_template': 'معاينة {preset}',
    'admin.branding.preview_menu': 'القائمة',
    'admin.branding.preview_selection_template': 'اختيار {name}',
    'admin.branding.preview_menu_card_text': 'بطاقات القائمة وعمق الخلفية وتباين اللون المميز لإعداد {preset}.',
    'admin.branding.swatch_primary': 'رئيسي',
    'admin.branding.swatch_secondary': 'ثانوي',
    'admin.branding.swatch_accent': 'تمييز',
    'admin.branding.preview_homepage_hero': 'واجهة الرئيسية',
    'admin.branding.preview_homepage': 'الرئيسية',
    'admin.branding.preview_order_online': 'اطلب الآن',
    'admin.branding.preview_menu_shell': 'القائمة',
    'admin.branding.preview_categories_card': 'الفئات + البطاقة',
    'admin.branding.preview_desserts': 'حلويات',
    'admin.branding.preview_beverages': 'مشروبات',
    'admin.branding.preview_signature_pick': 'اختيار مميز',
    'admin.branding.preview_signature': 'مميز',
    'admin.branding.preview_static_title': 'موقع المطعم',
    'admin.branding.preview_static_name': 'اسم المطعم',
    'admin.branding.preview_static_tagline': 'معاينة الشعار النصي وملخص الهوية',
    'admin.branding.preview_static_homepage_title': 'موقع المطعم',
    'admin.branding.preview_static_homepage_meta': 'خدمة دافئة وهوية محلية',
    'admin.branding.preview_static_chip_primary': 'المميز',
    'admin.branding.preview_static_card_title': 'طبق موسمي مميز',
    'admin.branding.preview_static_card_text': 'سطح البطاقة وأجواؤها وتباين اللون المميز لتجربة القائمة.',
